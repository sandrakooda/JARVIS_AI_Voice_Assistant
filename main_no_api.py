...
def main_process():
    while True:
        ...
        if "hello" in request:
            ...
            speak("Image generation is disabled since OpenAI API is not in use.")
        elif "ask ai" in request or "clear chat" in request:
            speak("AI features are disabled to avoid OpenAI API usage.")
        else:
